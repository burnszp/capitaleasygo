...
/**
 * <p>libraryspliceType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="libraryspliceType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;attGroup ref="{http://www.mentor.com/harness/Schema/LibrarySchema}SelectionAttributes"/>
 *       &lt;attribute name="lrratio" type="{http://www.mentor.com/harness/Schema/LibrarySchema}Decimal_12_6" default="0" />
 *       &lt;attribute name="maxwirelimit" type="{http://www.w3.org/2001/XMLSchema}unsignedInt" default="0" />
 *       &lt;attribute name="librarysplice_id" use="required" type="{http://www.mentor.com/harness/Schema/LibrarySchema}UID" />
...
@XmlType(name = "libraryspliceType")
public class LibraryspliceType implements Serializable{

    @XmlAttribute(name = "lrratio")
    protected String lrratio;
    @XmlAttribute(name = "maxwirelimit")
    @XmlSchemaType(name = "unsignedInt")
    protected Long maxwirelimit;
    @XmlAttribute(name = "librarysplice_id", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlID
    protected String libraryspliceId;
     ...
     *     
     */
    public void setLrratio(String value) {
        this.lrratio = value;
    }
     ...
     *     
     */
    public long getMaxwirelimit() {
        if (maxwirelimit == null) {
            return  0L;
        } else {
            return maxwirelimit;
        }
     ...
     *     
     */
    public void setMaxwirelimit(Long value) {
        this.maxwirelimit = value;
    }

    /**
     * 获取libraryspliceId属性的值。
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getLibraryspliceId() {
        return libraryspliceId;
    }

    /**
     * 设置libraryspliceId属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setLibraryspliceId(String value) {
        this.libraryspliceId = value;
    }
