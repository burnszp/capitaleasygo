...
/**
 * <p>connectorType complex type的 Java 类。
 * 
 ...
 *         &lt;element name="librarydressedroute" type="{http://www.mentor.com/harness/Schema/LibrarySchema}librarydressedrouteType"/>
    ...
    extends LibraryPartBaseType
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "librarydressedroute", type = LibrarydressedrouteType.class),
