...
/**
 * <p>librarysoldersleeveType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="librarysoldersleeveType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;attGroup ref="{http://www.mentor.com/harness/Schema/LibrarySchema}SelectionAttributes"/>
 *       &lt;attribute name="librarysoldersleeve_id" use="required" type="{http://www.mentor.com/harness/Schema/LibrarySchema}UID" />
...
@XmlType(name = "librarysoldersleeveType")
public class LibrarysoldersleeveType implements Serializable{

    @XmlAttribute(name = "librarysoldersleeve_id", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlID
    protected String librarysoldersleeveId;
     ...
     *     
     */
    public String getLibrarysoldersleeveId() {
        return librarysoldersleeveId;
    }

    /**
     * 设置librarysoldersleeveId属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setLibrarysoldersleeveId(String value) {
        this.librarysoldersleeveId = value;
    }
