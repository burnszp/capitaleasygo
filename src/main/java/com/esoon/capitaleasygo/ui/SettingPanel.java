...
public class SettingPanel extends JPanel {
	...
	public SettingPanel(Component aParent) {
	...
	private JScrollPane createList() {
		...
		scrollPane
				.setBorder(JTBorderFactory.createTitleBorder(ImageHelper.loadImage("themes.gif"), "Themes-List", 0, 0));
		return scrollPane;
	}
	...
	private JScrollPane createControl() {
		...
		leftTabButton.setSelected(true);
		...
		int row = 0;
		if (JTattooUtilities.getJavaVersion() >= 1.4) {
			GridBagHelper.addComponent(panel, taaCheck, 0, row++, 1, 1, 0, 0, 0.0, 0.0, GridBagConstraints.HORIZONTAL,
					GridBagConstraints.WEST);
		}
		GridBagHelper.addComponent(panel, leftToRightCheck, 0, row++, 1, 1, 0, 0, 0.0, 0.0,
				GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);
		if (JTattooUtilities.getJavaVersion() >= 1.4) {
			GridBagHelper.addComponent(panel, scrollableTabCheck, 0, row++, 1, 1, 0, 0, 0.0, 0.0,
					GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);
		}
		GridBagHelper.addComponent(panel, patternCheck, 0, row++, 1, 1, 0, 0, 0.0, 0.0, GridBagConstraints.HORIZONTAL,
				GridBagConstraints.WEST);
		GridBagHelper.addComponent(panel, new JSeparator(), 0, row++, 1, 1, 0, 0, 1.0, 0.0,
				GridBagConstraints.HORIZONTAL, GridBagConstraints.CENTER);
		GridBagHelper.addComponent(panel, topTabButton, 0, row++, 1, 1, 0, 0, 0.0, 0.0, GridBagConstraints.HORIZONTAL,
				GridBagConstraints.WEST);
		GridBagHelper.addComponent(panel, leftTabButton, 0, row++, 1, 1, 0, 0, 0.0, 0.0, GridBagConstraints.HORIZONTAL,
				GridBagConstraints.WEST);
		GridBagHelper.addComponent(panel, bottomTabButton, 0, row++, 1, 1, 0, 0, 0.0, 0.0,
				GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST);
		GridBagHelper.addComponent(panel, rightTabButton, 0, row++, 1, 1, 0, 0, 0.0, 0.0, GridBagConstraints.HORIZONTAL,
				GridBagConstraints.WEST);
		GridBagHelper.addComponent(panel, new JPanel(), 0, row++, 1, 1, 0, 0, 0.0, 1.0, GridBagConstraints.VERTICAL,
				GridBagConstraints.WEST);
