...
public class SettingDialog extends JDialog {
    ...
    public SettingDialog(Component aParent) {
        super(JOptionPane.getFrameForComponent(aParent), "Setting", true);
        parent = aParent;
        init();
    }
    ...
    private void init() {
        ...
        SettingPanel settingPanel = new SettingPanel(parent);
        aboutPanel.add(settingPanel);
        tabbedPane.add("Setting", aboutPanel);
