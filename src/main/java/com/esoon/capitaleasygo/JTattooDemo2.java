...
import com.esoon.capitaleasygo.ui.GUIProperties;
import com.esoon.capitaleasygo.ui.IDemoApp;
import com.esoon.capitaleasygo.ui.LeftPanel;
import com.esoon.capitaleasygo.ui.MainMenuBar;
        ...
        try {
            ...
            if (oldLAF instanceof AbstractLookAndFeel) {
               // BaseTheme theme = (BaseTheme)((AbstractLookAndFeel)oldLAF).getTheme();
            	AbstractTheme theme =  AbstractLookAndFeel.getTheme();
            ...
            if (newLAF instanceof AbstractLookAndFeel) {
                AbstractTheme theme =  AbstractLookAndFeel.getTheme();
                //(BaseTheme)((AbstractLookAndFeel)newLAF).getTheme();
...
//                mainPanel.updateLookAndFeel();
    ...
    public static void main(String args[]) {
	     ...
	     * 
	     * @return
	     * @see com.esoon.capitaleasygo.ui.IDemoApp#getMainPanel()
	     */
