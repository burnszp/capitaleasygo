...
@XmlRootElement(name = "unconstrainedframedecoration")
public class Unconstrainedframedecoration {
    ...
    protected List<Unconstrainedposition> unconstrainedposition;
    ...
    public String getType() {
        if (type == null) {
            return "unconstrainedframedecoration";
        } else {
            return type;
        }
    }
    ...
    /**
     * Gets the value of the unconstrainedposition property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the unconstrainedposition property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUnconstrainedposition().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link Unconstrainedposition }
     * 
     * 
     */
    public List<Unconstrainedposition> getUnconstrainedposition() {
        if (unconstrainedposition == null) {
            unconstrainedposition = new ArrayList<Unconstrainedposition>();
        }
        return this.unconstrainedposition;
    }
