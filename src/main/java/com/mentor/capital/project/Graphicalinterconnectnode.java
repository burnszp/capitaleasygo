...
@XmlRootElement(name = "graphicalinterconnectnode")
public class Graphicalinterconnectnode {

    @XmlAttribute(name = "id")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlID
    protected String id;
    @XmlAttribute(name = "interconnectnoderef", required = true)
    @XmlIDREF
    protected Object interconnectnoderef;
     ...
     *     
     */
    public Object getInterconnectnoderef() {
        return interconnectnoderef;
    }

    /**
     * Sets the value of the interconnectnoderef property.
     * 
     * @param value
     *     allowed object is
     *     {@link Object }
     *     
     */
    public void setInterconnectnoderef(Object value) {
        this.interconnectnoderef = value;
    }
