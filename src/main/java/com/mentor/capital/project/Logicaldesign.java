...
@XmlRootElement(name = "logicaldesign")
public class Logicaldesign {
    ...
    @XmlAttribute(name = "concurrentwatermarksync")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String concurrentwatermarksync;
    ...
    /**
     * Gets the value of the concurrentwatermarksync property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getConcurrentwatermarksync() {
        if (concurrentwatermarksync == null) {
            return "false";
        } else {
            return concurrentwatermarksync;
        }
    }

    /**
     * Sets the value of the concurrentwatermarksync property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setConcurrentwatermarksync(String value) {
        this.concurrentwatermarksync = value;
    }
