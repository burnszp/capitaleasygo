...
@XmlRootElement(name = "usagedef")
public class Usagedef {
    ...
    protected List<Deviceusage> deviceusage;
    ...
    /**
     * Gets the value of the deviceusage property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the deviceusage property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDeviceusage().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<Deviceusage> getDeviceusage() {
        if (deviceusage == null) {
            deviceusage = new ArrayList<Deviceusage>();
        }
