...
@XmlRootElement(name = "topologymgr")
public class Topologymgr {
    ...
    protected List<Functionaldesignref> functionaldesignref;
    protected Logicdesignref logicdesignref;
    ...
    /**
     * Gets the value of the functionaldesignref property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the functionaldesignref property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFunctionaldesignref().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link Functionaldesignref }
     * 
     * 
     */
    public List<Functionaldesignref> getFunctionaldesignref() {
        if (functionaldesignref == null) {
            functionaldesignref = new ArrayList<Functionaldesignref>();
        }
        return this.functionaldesignref;
    }

    /**
     * Gets the value of the logicdesignref property.
     * 
     * @return
     *     possible object is
     *     {@link Logicdesignref }
     *     
     */
    public Logicdesignref getLogicdesignref() {
        return logicdesignref;
    }

    /**
     * Sets the value of the logicdesignref property.
     * 
     * @param value
     *     allowed object is
     *     {@link Logicdesignref }
     *     
     */
    public void setLogicdesignref(Logicdesignref value) {
        this.logicdesignref = value;
    }
