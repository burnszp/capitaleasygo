...
@XmlType(name = "", propOrder = {
    "advnameidx",
    "pinOrInternalpinOrInterconnectpinOrProperty",
    "deviceconnector"
})
@XmlRootElement(name = "interconnectdevice")
public class Interconnectdevice {
    ...
    protected List<Object> pinOrInternalpinOrInterconnectpinOrProperty;
    ...
    /**
     * Gets the value of the pinOrInternalpinOrInterconnectpinOrProperty property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pinOrInternalpinOrInterconnectpinOrProperty property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPinOrInternalpinOrInterconnectpinOrProperty().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getPinOrInternalpinOrInterconnectpinOrProperty() {
        if (pinOrInternalpinOrInterconnectpinOrProperty == null) {
            pinOrInternalpinOrInterconnectpinOrProperty = new ArrayList<Object>();
        }
        return this.pinOrInternalpinOrInterconnectpinOrProperty;
    }
