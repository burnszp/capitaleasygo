...
@XmlType(name = "", propOrder = {
    "advnameidx",
    "terminalblockOrTerminalblockconnectorOrBarOrJumperOrProperty"
})
@XmlRootElement(name = "terminalbar")
public class Terminalbar {
    ...
    @XmlElements({
        @XmlElement(name = "terminalblock", type = Terminalblock.class),
        @XmlElement(name = "terminalblockconnector", type = Terminalblockconnector.class),
        @XmlElement(name = "bar", type = Bar.class),
        @XmlElement(name = "jumper", type = Jumper.class),
        @XmlElement(name = "property", type = Property.class)
    })
    protected List<Object> terminalblockOrTerminalblockconnectorOrBarOrJumperOrProperty;
    ...
    /**
     * Gets the value of the terminalblockOrTerminalblockconnectorOrBarOrJumperOrProperty property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the terminalblockOrTerminalblockconnectorOrBarOrJumperOrProperty property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTerminalblockOrTerminalblockconnectorOrBarOrJumperOrProperty().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getTerminalblockOrTerminalblockconnectorOrBarOrJumperOrProperty() {
        if (terminalblockOrTerminalblockconnectorOrBarOrJumperOrProperty == null) {
            terminalblockOrTerminalblockconnectorOrBarOrJumperOrProperty = new ArrayList<Object>();
        }
        return this.terminalblockOrTerminalblockconnectorOrBarOrJumperOrProperty;
    }
