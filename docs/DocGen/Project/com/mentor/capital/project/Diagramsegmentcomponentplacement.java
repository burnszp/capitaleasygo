...
@XmlType(name = "")
@XmlRootElement(name = "diagramsegmentcomponentplacement")
public class Diagramsegmentcomponentplacement {
    ...
    @XmlAttribute(name = "anchortostart")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String anchortostart;
    ...
    /**
     * Gets the value of the anchortostart property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getAnchortostart() {
        if (anchortostart == null) {
            return "true";
        } else {
    ...
    /**
     * Sets the value of the anchortostart property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setAnchortostart(String value) {
        this.anchortostart = value;
    }
